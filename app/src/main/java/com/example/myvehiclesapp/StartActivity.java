...
public class StartActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,com.google.android.gms.location.LocationListener {
    ...
    private long FASTEST_INTERVAL = 5 * 2000; /* 2 sec */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showMap = findViewById(R.id.show_in_map);
    ...
    public void onLocationChanged(Location location) {
        ...
        AddDataIntoFirebase(String.valueOf(location.getLatitude()),String.valueOf(location.getLongitude()));
    ...
    private void AddDataIntoFirebase(String valueOfLatitude, String valueOfLongitude) {
        ...
        locationRoot.child(uid).setValue(main).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(StartActivity.this, "Updated", Toast.LENGTH_SHORT).show();
            }
        });
    }
